...
/**
 * The persistent class for the tblAPPROVED_WARRANTY_CLAIM_DATA_HIST database table.
 * 
 */
@Embeddable
@Table(name="tblAPPROVED_WARRANTY_CLAIM_DATA_HIST")
@NamedQuery(name="TblAPPROVED_WARRANTY_CLAIM_DATA_HIST.findAll", query="SELECT t FROM TblAPPROVED_WARRANTY_CLAIM_DATA_HIST t")
public class TblAPPROVED_WARRANTY_CLAIM_DATA_HIST implements Serializable {
	...
	public TblAPPROVED_WARRANTY_CLAIM_DATA_HIST() {
	}
