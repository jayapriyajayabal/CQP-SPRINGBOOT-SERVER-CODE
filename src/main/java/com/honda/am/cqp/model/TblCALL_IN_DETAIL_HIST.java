...
/**
 * The persistent class for the tblCALL_IN_DETAIL_HIST database table.
 * 
 */
@Entity
@Table(name="tblCALL_IN_DETAIL_HIST")
@NamedQuery(name="TblCALL_IN_DETAIL_HIST.findAll", query="SELECT t FROM TblCALL_IN_DETAIL_HIST t")
public class TblCALL_IN_DETAIL_HIST implements Serializable {
	...
	@Column(name="FIXED_RESPONSIBILITY")
	private BigDecimal fixedResponsibility;
	...
	public BigDecimal getFixedResponsibility() {
		return this.fixedResponsibility;
	}

	public void setFixedResponsibility(BigDecimal fixedResponsibility) {
		this.fixedResponsibility = fixedResponsibility;
	}
