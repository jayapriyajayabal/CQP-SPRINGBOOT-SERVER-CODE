...
/**
 * The persistent class for the tblPART_COST_INFO_temp database table.
 * 
 */
@Embeddable
@Table(name="tblPART_COST_INFO_temp")
@NamedQuery(name="TblPART_COST_INFO_temp.findAll", query="SELECT t FROM TblPART_COST_INFO_temp t")
public class TblPART_COST_INFO_temp implements Serializable {
