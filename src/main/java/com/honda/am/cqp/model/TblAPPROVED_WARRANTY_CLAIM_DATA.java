...
/**
 * The persistent class for the tblAPPROVED_WARRANTY_CLAIM_DATA database table.
 * 
 */
@Embeddable
@Table(name="tblAPPROVED_WARRANTY_CLAIM_DATA")
@NamedQuery(name="TblAPPROVED_WARRANTY_CLAIM_DATA.findAll", query="SELECT t FROM TblAPPROVED_WARRANTY_CLAIM_DATA t")
public class TblAPPROVED_WARRANTY_CLAIM_DATA implements Serializable {
	...
	public TblAPPROVED_WARRANTY_CLAIM_DATA() {
	}
