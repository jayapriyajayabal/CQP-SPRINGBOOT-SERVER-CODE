...
/**
 * The persistent class for the tblTRANSFER_PART_LIST_DETAIL database table.
 * 
 */
@Entity
@Table(name="tblTRANSFER_PART_LIST_DETAIL")
@NamedQuery(name="TbltransferPartListDetail.findAll", query="SELECT t FROM TbltransferPartListDetail t")
public class TbltransferPartListDetail implements Serializable {
	...
	public TbltransferPartListDetail() {
	}
