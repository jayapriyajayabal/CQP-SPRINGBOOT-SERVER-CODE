...
/**
 * The persistent class for the tblAPPROVED_WARRANTY_CLAIM_DATA_TEMP database table.
 * 
 */
@Embeddable
@Table(name="tblAPPROVED_WARRANTY_CLAIM_DATA_TEMP")
@NamedQuery(name="TblAPPROVED_WARRANTY_CLAIM_DATA_TEMP.findAll", query="SELECT t FROM TblAPPROVED_WARRANTY_CLAIM_DATA_TEMP t")
public class TblAPPROVED_WARRANTY_CLAIM_DATA_TEMP implements Serializable {
	...
	public TblAPPROVED_WARRANTY_CLAIM_DATA_TEMP() {
	}
