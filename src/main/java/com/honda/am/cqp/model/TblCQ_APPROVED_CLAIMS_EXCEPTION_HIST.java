...
/**
 * The persistent class for the tblCQ_APPROVED_CLAIMS_EXCEPTION_HIST database table.
 * 
 */
@Embeddable
@Table(name="tblCQ_APPROVED_CLAIMS_EXCEPTION_HIST")
@NamedQuery(name="TblCQ_APPROVED_CLAIMS_EXCEPTION_HIST.findAll", query="SELECT t FROM TblCQ_APPROVED_CLAIMS_EXCEPTION_HIST t")
public class TblCQ_APPROVED_CLAIMS_EXCEPTION_HIST implements Serializable {
	...
	public TblCQ_APPROVED_CLAIMS_EXCEPTION_HIST() {
	}
