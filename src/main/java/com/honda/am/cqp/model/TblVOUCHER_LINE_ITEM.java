...
/**
 * The persistent class for the tblVOUCHER_LINE_ITEM database table.
 * 
 */
@Entity
@Table(name="tblVOUCHER_LINE_ITEM")
@NamedQuery(name="TblVOUCHER_LINE_ITEM.findAll", query="SELECT t FROM TblVOUCHER_LINE_ITEM t")
public class TblVOUCHER_LINE_ITEM implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name="VOUCHER_LINE_ITEM_SK")
	private int voucherLineItemSk;
	...
	public TblVOUCHER_LINE_ITEM() {
	}

	public int getVoucherLineItemSk() {
		return this.voucherLineItemSk;
	}

	public void setVoucherLineItemSk(int voucherLineItemSk) {
		this.voucherLineItemSk = voucherLineItemSk;
	}
