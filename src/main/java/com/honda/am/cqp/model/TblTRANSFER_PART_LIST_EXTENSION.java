...
/**
 * The persistent class for the tblTRANSFER_PART_LIST_EXTENSION database table.
 * 
 */
@Entity
@Table(name="tblTRANSFER_PART_LIST_EXTENSION")
@NamedQuery(name="TblTRANSFER_PART_LIST_EXTENSION.findAll", query="SELECT t FROM TblTRANSFER_PART_LIST_EXTENSION t")
public class TblTRANSFER_PART_LIST_EXTENSION implements Serializable {
	...
	public TblTRANSFER_PART_LIST_EXTENSION() {
	}
