...
/**
 * The persistent class for the tblTRANSFER_PART_LIST_COMMENT database table.
 * 
 */
@Entity
@Table(name="tblTRANSFER_PART_LIST_COMMENT")
@NamedQuery(name="TblTRANSFER_PART_LIST_COMMENT.findAll", query="SELECT t FROM TblTRANSFER_PART_LIST_COMMENT t")
public class TblTRANSFER_PART_LIST_COMMENT implements Serializable {
	...
	public TblTRANSFER_PART_LIST_COMMENT() {
	}
