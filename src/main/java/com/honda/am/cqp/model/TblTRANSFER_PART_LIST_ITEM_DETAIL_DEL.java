...
/**
 * The persistent class for the tblTRANSFER_PART_LIST_ITEM_DETAIL_DEL database table.
 * 
 */
@Entity
@Table(name="tblTRANSFER_PART_LIST_ITEM_DETAIL_DEL")
@NamedQuery(name="TblTRANSFER_PART_LIST_ITEM_DETAIL_DEL.findAll", query="SELECT t FROM TblTRANSFER_PART_LIST_ITEM_DETAIL_DEL t")
public class TblTRANSFER_PART_LIST_ITEM_DETAIL_DEL implements Serializable {
	...
	public TblTRANSFER_PART_LIST_ITEM_DETAIL_DEL() {
	}
