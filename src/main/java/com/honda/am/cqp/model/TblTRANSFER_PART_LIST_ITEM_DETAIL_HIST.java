...
/**
 * The persistent class for the tblTRANSFER_PART_LIST_ITEM_DETAIL_HIST database table.
 * 
 */
@Entity
@Table(name="tblTRANSFER_PART_LIST_ITEM_DETAIL_HIST")
@NamedQuery(name="TblTRANSFER_PART_LIST_ITEM_DETAIL_HIST.findAll", query="SELECT t FROM TblTRANSFER_PART_LIST_ITEM_DETAIL_HIST t")
public class TblTRANSFER_PART_LIST_ITEM_DETAIL_HIST implements Serializable {
	...
	public TblTRANSFER_PART_LIST_ITEM_DETAIL_HIST() {
	}
