...
/**
 * The persistent class for the tblCQ_APPROVED_CLAIMS database table.
 * 
 */
@Embeddable
@Table(name="tblCQ_APPROVED_CLAIMS")
@NamedQuery(name="TblCQ_APPROVED_CLAIM.findAll", query="SELECT t FROM TblCQ_APPROVED_CLAIM t")
public class TblCQ_APPROVED_CLAIM implements Serializable {
