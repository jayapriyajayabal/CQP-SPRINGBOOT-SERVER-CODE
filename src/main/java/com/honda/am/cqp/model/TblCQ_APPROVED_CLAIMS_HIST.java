...
/**
 * The persistent class for the tblCQ_APPROVED_CLAIMS_HIST database table.
 * 
 */
@Embeddable
@Table(name="tblCQ_APPROVED_CLAIMS_HIST")
@NamedQuery(name="TblCQ_APPROVED_CLAIMS_HIST.findAll", query="SELECT t FROM TblCQ_APPROVED_CLAIMS_HIST t")
public class TblCQ_APPROVED_CLAIMS_HIST implements Serializable {
	...
	public TblCQ_APPROVED_CLAIMS_HIST() {
	}
