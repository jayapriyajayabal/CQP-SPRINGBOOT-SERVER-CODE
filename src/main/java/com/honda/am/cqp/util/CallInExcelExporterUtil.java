...
public class CallInExcelExporterUtil {
    ...
    private void writeDataLines() {
        ...
        for (CallInDto callIn : listAlerts) {
            ...
            createCell(row, columnCount++, callIn.getSupplierNumber(), style);
            createCell(row, columnCount++, callIn.getSupplierName(), style);
            createCell(row, columnCount++, callIn.getStatus(), style);
        }
    }
